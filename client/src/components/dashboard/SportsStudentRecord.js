...
class SportsStudentRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
            count:props.count,
                    ...
                    <div className="table-wrapper table-responsive table-bordered ">
                        <table className="table table-hover mb-0" variant='dark' cellSpacing="0" width="100%">
                            <tbody >
                                ...
                                <td style={{width:"19%"}}>{this.state.goodId}</td>
                                <td style={{width:"19%"}}>{this.state.goodType}</td>
...
export default SportsStudentRecord;